async function pageFunction(context) {
    ...
    function crawlPage(entry) {
        ...
        entry.size = parseNumber($("div.container-titlu div.label-listing2 li:contains('Teren')"));
        entry.house = parseNumber($("div.container-titlu div.label-listing2 li:contains('Suprafata utila')"));
        entry.rooms = parseNumber($("div.container-titlu div.label-listing2 li:contains('camere')"));
        entry.baths = $("div.caracteristici div.label-details:contains('2+ gr. sanitare')").length == 0 ? 0 : 2;
        entry.year = parseNumber($("div.container-titlu div.label-listing2 li:contains('An')"));
